...
const ownerMenu = (props: any) => {
    ...
    return (
        <Menu style={{ width: "75%", backgroundColor: "#EE3936", flex: 1 }}
            ...
            <MenuItem onPress={() => {
                hideMenu
                rentScooter(props.props, data)
            }}>
                <View style={styles.menuItemStyle}>
                    <View>
                        <Text style={FontHelper.subHeading}>Rent Kickscooter &nbsp;</Text>
                    </View>
                    <View>
                        <MatCom name='scooter' size={30} />
                    </View>
                </View>
            </MenuItem>
            <MenuDivider />
            <MenuItem onPress={() => {
                hideMenu
                mBook(props.props, data)
            }}>
                <View style={styles.menuItemStyle}>
                    <View>
                        <Text style={FontHelper.subHeading}>Maintainance Book &nbsp;</Text>
                    </View>
                    <View>
                        <Oct name='report' size={30} />
                    </View>
                </View>
            </MenuItem>
            <MenuDivider />
